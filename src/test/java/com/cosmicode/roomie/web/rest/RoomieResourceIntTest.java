...
public class RoomieResourceIntTest {
    ...
    private static final String DEFAULT_PHONE = "(+7) 197.  584 .19";
    private static final String UPDATED_PHONE = "+1&-0-95005950 1101";
    ...
    @Autowired
    private RoomieStateService roomieStateServiceMock;
    ...
    public void setup() {
        ...
        final RoomieResource roomieResource = new RoomieResource(roomieService, roomieStateService, addressService, userPreferencesService);
    ...
    public void getAllRoomiesWithEagerRelationshipsIsEnabled() throws Exception {
        RoomieResource roomieResource = new RoomieResource(roomieServiceMock, roomieStateServiceMock, addressServiceMock, userPreferencesServiceMock);
