...
import { RoomEventComponent } from 'app/entities/room-event/room-event.component';
...
describe('Component Tests', () => {
    describe('RoomEvent Management Component', () => {
        let comp: RoomEventComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(RoomEventComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.roomEvents[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
