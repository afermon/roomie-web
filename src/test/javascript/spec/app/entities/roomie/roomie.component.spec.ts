...
import { RoomieComponent } from 'app/entities/roomie/roomie.component';
import { RoomieService } from 'app/entities/roomie/roomie.service';
import { Roomie } from 'app/shared/model/roomie.model';

describe('Component Tests', () => {
    describe('Roomie Management Component', () => {
        let comp: RoomieComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(RoomieComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.roomies[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
