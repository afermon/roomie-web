...
import { RoomPictureComponent } from 'app/entities/room-picture/room-picture.component';
...
describe('Component Tests', () => {
    describe('RoomPicture Management Component', () => {
        let comp: RoomPictureComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(RoomPictureComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.roomPictures[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
