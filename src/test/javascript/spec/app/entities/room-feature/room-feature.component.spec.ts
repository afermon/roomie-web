...
import { RoomFeatureComponent } from 'app/entities/room-feature/room-feature.component';
...
describe('Component Tests', () => {
    describe('RoomFeature Management Component', () => {
        let comp: RoomFeatureComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(RoomFeatureComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.roomFeatures[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
