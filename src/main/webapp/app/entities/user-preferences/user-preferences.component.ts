...
export class UserPreferencesComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.userPreferencesService
                ...
                .subscribe(
                    (res: HttpResponse<IUserPreferences[]>) => this.paginateUserPreferences(res.body, res.headers),
    ...
    protected paginateUserPreferences(data: IUserPreferences[], headers: HttpHeaders) {
